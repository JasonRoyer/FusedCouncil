            ...
            name = "Response Buttons",
              args = {
                  ...
                  button2 = {
                    type = "input",
                    name = "button2",
                    set = function(info, val) responseNames[2] = val end,
                    get  = function(info, val) return responseNames[2] end,
                  },
                  button3 = {
                    type = "input",
                    name = "button3",
                    set = function(info, val) responseNames[3] = val end,
                    get  = function(info, val) return responseNames[3] end,
                  },
                  button4 = {
                    type = "input",
                    name = "button4",
                    set = function(info, val) responseNames[4] = val end,
                    get  = function(info, val) return responseNames[4] end,
                  },
              },      
          },              
       },
